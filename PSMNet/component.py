...
class FeatureExtractor(keras.Model):
    ...
    def __init__(self, filters):
        ...
        self.conv1_x = make_blocks(filters, 1, 3)

        self.conv2_1 = BasicBlockDown(filters, 1)
        self.conv2_x = make_blocks(2 * filters, 1, 13)

        self.conv3_x = make_blocks(2 * filters, 2, 3)

        self.conv4_x = make_blocks(2 * filters, 4, 3)
